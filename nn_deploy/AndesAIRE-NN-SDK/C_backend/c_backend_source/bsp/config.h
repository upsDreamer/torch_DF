...
/* this define control the output result: 1 - play audio */
// #define OUTPUT_PLAY_SOUND 1
/* this define control the output result: 1 - show big text */
// #define OUTPUT_SHOW_TEXT 1
