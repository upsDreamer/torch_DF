...
def main(args):
    ...
    model, _, _ = init_df(config_allow_defaults=True, model_base_dir=args.model_base_dir)#'DeepFilterNet3')
    model.to('cpu')
    model.eval()
    ...
    for clip in tqdm(clips):
        ...
        t = time.time() - t0
        t_audio = enhanced_audio.shape[-1] / 48000
        rtf = t / t_audio
        print("audio len = {}s  process time = {}s  rtf = {}".format(t_audio, t, rtf))
